...
const RegisteredAssessments: React.FC<RegisteredAssessmentsProps> = ({ initialSearchPatientName = '' }) => {
  ...
  const fetchAssessments = async () => {
    ...
    try {
      ...
      setIsAssessmentsTableMissing(getIsAssessmentsTableMissing());
    } catch (err) {
              ...
              <div className="grid grid-cols-2 gap-6 p-6 rounded-3xl" style={{ backgroundColor: '#f8fafc', border: '1px solid #f1f5f9' }}>
                ...
                <div className="space-y-3 pl-6 border-l border-slate-200">
                  <div>
                    ...
                    <span className="text-sm font-extrabold text-slate-850 block break-words leading-tight">{selectedAssessment.doctor_ref || 'N/A'}</span>
                  </div>
                  <div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-12 gap-6 items-start">
                  ...
                  <div className="col-span-7 rounded-3xl p-5 flex flex-col items-center justify-center min-h-[350px]" style={{ backgroundColor: '#f8fafc', border: '1px solid #f1f5f9' }}>
                    <div className="w-full flex items-center justify-between gap-2 mb-3 border-b border-dashed border-slate-200 pb-2.5">
                      <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Live Sizing Schematic Chart</span>
                      <span className="text-[9px] font-bold text-blue-600 uppercase font-mono">CALIBRATED</span>
                    </div>
