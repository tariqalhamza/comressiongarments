...
const getGarmentType = (diag: string) => {
  ...
  if (d.includes('bra') || d.includes('sports bra')) {
    return 'Sports Bra';
  }
...
const SmartDiagram: React.FC<{ 
  ...
  const formatVal = (label: string) => {
    ...
    if (!val) {
      ...
      else if (label === 'Diaphrom' || label === 'Diaphrarm') val = subOptions['Diaphrarm'] || subOptions['Diaphrom'] || subOptions['diaphrarm'];
      else if (label === 'Chest') val = subOptions['Chest'] || subOptions['chest'];
      else if (label === 'Armpit' || label === 'Arm Pit') val = subOptions['Armpit'] || subOptions['Arm Pit'] || subOptions['armpit'];
      else if (label === 'Shoulder') val = subOptions['Shoulder'] || subOptions['shoulder'];
      else if (label === 'Total length' || label === 'Total Length') val = subOptions['Total length'] || subOptions['Total Length'] || subOptions['total_length'];
      ...
      else if (label === 'Width diapharm to waist' || label === 'Width diaphrom to waist' || label === 'Length Diaphrom to West' || label === 'Length Diaphrom to Waist') val = subOptions['Length Diaphrom to Waist'] || subOptions['Length Diaphrom to West'] || subOptions['length diaphragm to waist'];
        ...
        return (
          <div className="flex flex-col items-center w-full">
            <svg viewBox="0 0 320 320" className="w-full h-full max-h-[500px]" style={{ minHeight: '320px' }}>
              <defs>
                <marker id="arrow-blue-sb-rep" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                  <path d="M 0 0 L 10 5 L 0 10 z" fill="#2563eb" />
                </marker>
                <marker id="arrow-emerald-sb-rep" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                  <path d="M 0 0 L 10 5 L 0 10 z" fill="#10b981" />
                </marker>
                <marker id="arrow-amber-sb-rep" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                  <path d="M 0 0 L 10 5 L 0 10 z" fill="#d97706" />
                </marker>
                <marker id="arrow-purple-sb-rep" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                  <path d="M 0 0 L 10 5 L 0 10 z" fill="#7c3aed" />
                </marker>
                <marker id="arrow-rose-sb-rep" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                  <path d="M 0 0 L 10 5 L 0 10 z" fill="#dc2626" />
                </marker>
              </defs>
              ...
              <line x1="45" y1="55" x2="45" y2="240" stroke="#dc2626" strokeWidth="1.5" markerStart="url(#arrow-rose-sb-rep)" markerEnd="url(#arrow-rose-sb-rep)" />
      ...
      case 'Belly Belt':
        return (
          <div className="flex flex-col items-center w-full">
            <svg viewBox="0 0 320 320" className="w-full h-full max-h-[500px]" style={{ minHeight: '320px' }}>
              <defs>
                <marker id="arrow-rose-bbelt-rep" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5" orient="auto-start-reverse">
                  <path d="M 0 0 L 10 5 L 0 10 z" fill="#dc2626" />
                </marker>
              </defs>
              ...
              <line x1="45" y1="70" x2="45" y2="210" stroke="#dc2626" strokeWidth="1.5" markerStart="url(#arrow-rose-bbelt-rep)" markerEnd="url(#arrow-rose-bbelt-rep)" />
